...
# -*- coding: utf-8 -*-
#
# EOLE documentation build configuration file.
...
extensions = [
    ...
    "sphinx.ext.autodoc",
    "sphinx.ext.mathjax",
    "sphinx_github_style",  # custom ext adapted for md build
    # "sphinx.ext.linkcode",
    # "sphinx.ext.viewcode",
    "sphinx.ext.coverage",
...
latex_documents = [
    (master_doc, "eole.tex", "EOLE Documentation", "team", "manual"),
]
...
man_pages = [(master_doc, "eole", "EOLE Documentation", [author], 1)]
