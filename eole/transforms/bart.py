...
class BARTNoiseTransform(Transform):
    ...
    def warm_up(self, vocabs):
        ...
        subword_type = self.config.src_subword_type
        ...
        self.bart_noise = BARTNoising(
            ...
            insert_ratio=self.config.insert_ratio,
            permute_sent_ratio=self.config.permute_sent_ratio,
            poisson_lambda=self.config.poisson_lambda,
            replace_length=self.config.replace_length,
            rotate_ratio=self.config.rotate_ratio,
